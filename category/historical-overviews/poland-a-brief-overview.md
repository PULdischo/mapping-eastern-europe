...
item_image_caption: Marginalia and illuminated initial from the Psalter of Saint Florian.
  This trilingual psalter (in Latin, German, and Polish) is believed to have been
  made in the scriptorium of the Augustinian canons in Kłodzko, Silesia, in the late
  14th century, possibly for Queen Jadwiga. The Polish translation of the Psalms is
  one of the oldest texts written in Polish. Warsaw, Biblioteka Narodowa, Rps 8002
  III, fol. 18r (detail).
slider_images:
- slider_image: /assets/media/items/charter_krakow_1257.jpg
  caption: 'Locatio charter of Boleslaus V the Chaste for Kraków, 1257\. Source: public
    domain https://mykrak.typepad.com/blog/2018/04/akt\-lokacyjny\-miasta\-krakowa\-1257\.html'
- slider_image: /assets/media/items/Wawel_hill.jpg
  caption: 'Wawel Castle, Kraków. Source: Wikipedia Commons'
- slider_image: /assets/media/items/Poland_Map_1.png
  caption: 'Map of Poland during the reign of Mesco I (c. 960\-992\) Source: Wikipedia
    Commons'
- slider_image: /assets/media/items/Poland_Map_2.png
  caption: 'Map of Poland and Lithuania under Ladislaus II Jagiellon (1386\-1434\)
...
See also the article “[**Silesia: A Brief Overview**](https://mappingeasterneurope.princeton.edu/item/silesia-a-brief-overview.html).”

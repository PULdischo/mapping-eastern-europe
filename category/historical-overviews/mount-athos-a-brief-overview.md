...
item_image_caption: 'Map of Mount Athos by Gerasimos Smyrnakis (source: Archive of
  Mount Athos Center)'
slider_images:
- slider_image: /assets/media/items/ANASTASIOS_NTOUROS_MAC_2.jpg
  caption: 'Dionysiou Monastery, Mount Athos (source: Archive of Mount Athos Center)'
- slider_image: /assets/media/items/ANASTASIOS_NTOUROS_MAC_3.JPG
  caption: 'Iviron Monastery, Mount Athos (source: Archive of Mount Athos Center)'
- slider_image: /assets/media/items/ANASTASIOS_NTOUROS_MAC_4.jpg
  caption: 'Simonos Petras Monastery, Mount Athos (source: Archive of Mount Athos
    Center)'
- slider_image: /assets/media/items/ANASTASIOS_NTOUROS_MAC_5.JPG
  caption: 'Interior view of the Katholikon (main church) of Vatopedi Monastery (source:
    Archive of Mount Athos Center)'
- slider_image: /assets/media/items/ANASTASIOS_NTOUROS_MAC_6.JPG
  caption: 'The Kaholikon (main church) of the Great Lavra, Mount Athos (source: Archive
    of Mount Athos Center)'
start_year: 1150
end_year: 1750
author: Anastasios Ntouros
type: []
locations:
- Greece
subjects: []
...
Papachryssanthou, Denise, ed. *Actes du Prôtaton*. Paris: Lethielleux, 1975\.

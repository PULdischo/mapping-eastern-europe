...
item_image_caption: 'Sultan Mehmet II and Patriarch Gennadios II Scholarios. Modern
  mosaic by Soterios Varvoglis in the Patriarchal palace of Istanbul (source: Wikimedia
  Commons)'
slider_images:
- slider_image: /assets/media/items/02_aQgtgOm.jpg
  caption: 'Hagia Sophia, Constantinople/Istanbul (source: Wikimedia Commons)'
- slider_image: /assets/media/items/03_fFBXov9.jpg
  caption: 'Hagia Sophia of Nicaea (source: Wikimedia Commons)'
- slider_image: /assets/media/items/04_Er241II.jpg
  caption: 'Frontispiece of the Double\-Headed Eagle (Source: Wikimedia Commons)'
- slider_image: /assets/media/items/05_zba8F6w.jpg
  caption: 'Portrait of Kyrillos Loukaris. Geneva 1632 – International Museum of Reformation,
    Hall of ‘Banquet of Predestination’, Unknown painter (source: Wikimedia Commons)'
- slider_image: /assets/media/items/06_oWB6uaB.jpg
  caption: 'Main entrance of the St George Patriarchal Cathedral (source: Wikimedia
    Commons)'
- slider_image: /assets/media/items/07.png
  caption: 'Main entrance of the Patriarchal Academy of Phanar (source: Wikimedia
    Commons)'
start_year: 1201
end_year: 1699

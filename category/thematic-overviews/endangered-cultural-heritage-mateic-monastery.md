...
item_image_caption: 'Photograph of Mateič Monastery from 1934 by architect Đurđe Bošković
  (source: J. Ćirić)'
slider_images:
- slider_image: /assets/media/items/img437.jpg
  caption: 'Photograph of Mateič Monastery from 1934 by architect Đurđe Bošković (source:
    J. Ćirić)'
- slider_image: /assets/media/items/img550.jpg
  caption: 'Layout, Mateič Monastery, executed by architect Đurđe Bošković in 1934
    (source: J. Ćirić)'
- slider_image: /assets/media/items/stained_glass_Mateic_monastery_Legacy_of_%C4%90ur%C4%91e_Boskovic.jpg
  caption: 'Piece of glass from the main dome, collection of the architect Đurđe Bošković
    (source: J. Ćirić)'
- slider_image: /assets/media/items/01_Crkva_Uspenja_Mateic_foto_Jasmina_S._Ciric.JPG
  caption: 'Mateič Monastery, exterior view (source: J. Ćirić)'
- slider_image: /assets/media/items/02_Opeka_na_stranicama_centralne_kupole_foto_Jasmina_S._Ciric.JPG
  caption: 'Mateič Monastery, exterior view (source: J. Ćirić)'
- slider_image: /assets/media/items/03_oltarska_bifora.JPG
  caption: 'Mateič Monastery, exterior view (source: J. Ćirić)'
- slider_image: /assets/media/items/04_Trivilon_unutrasnjos_crkve_Uspenja_Bogorodicinog_Mateic_foto_Jasmina_S._Ciric.JPG
  caption: 'Mateič Monastery, interior view (source: J. Ćirić)'
- slider_image: /assets/media/items/05_Loza_Jesejeva_Mateic_foto_Jasmina_S._Ciric.JPG
  caption: 'Mateič Monastery, interior view (source: J. Ćirić)'
- slider_image: /assets/media/items/06_Pogled_na_severozapadnu_kupolu_iz_enterijera_foto_Jasmina_S._Ciric.JPG
  caption: 'Mateič Monastery, interior view (source: J. Ćirić)'
- slider_image: /assets/media/items/07_Zoomorfni_simvol_orao_kapitel_u_naosu_Mateic_foto_Jasmina_S._Ciric.JPG
  caption: 'Mateič Monastery, interior view (source: J. Ćirić)'
- slider_image: /assets/media/items/08_Grafiti_na_fresci_Svetog_Apostola_Petra_foto_Joris_Kila.jpg
  caption: 'Mateič Monastery, interior view (source: J. Ćirić)'
- slider_image: /assets/media/items/09_MATEJCESv.Bogorodica.jpg
  caption: 'Mateič Monastery, interior view (source: J. Ćirić)'
start_year: 1280
end_year: 1350
author: Jasmina S. Ćirić
type:
- Monumental art
locations:
...
Earlier this year, the office of Ms. Irena Stefoska, the Minister of Culture of the Republic of North Macedonia, announced that one million Macedonian denars had been allocated from the funds intended for immovable cultural heritage for preventive interventions in architecture and painting of the church in Mateič, which should be implemented by the **[National Conservation Center in Skopje](http://kultura.gov.mk/stefoska-bucetot-za-kulturata-vo-20201-e-realen-prilagoden-na-okolnostite-i-proektiran-spored-kovid-uslovite/)**. Twenty years after the conflicts caused by the Albanian paramilitary National Liberation Army, there is hope that the long period of negligence will stop and that the dignity of the Monastery of the Most Holy Mother of God in Mateič, the remarkable work of its founders, will be properly restored.  

...
item_image_caption: 'Gilded helmet of the Kıpçak chieftain from the burial in Chungul
  Kurgan. Treasury of National Museum of the History of Ukraine (source: D. V. Klochko)'
slider_images:
- slider_image: /assets/media/items/2BurialClose.png
  caption: 'Close view of the burial during the excavation, 1981\. The electrum belt
    is put around the neck of the deceased as a sign of submission to gods. On the
    waist is one of Crusader belts. Also discernable compositions of embroidery and
    metal plaques, decorating the loros kaftan and the inner tunic. The photograph
    demonstrates impressively meticulous work of the archeologists. (source: V. I.
    Klochko)'
- slider_image: /assets/media/items/3Beltcup.jpg
  caption: 'The Byzantine enameled guilt belt cup, decorated with the motives of spring
    garden and dancing girls (restored). Institute of Archeology of Academy of Sciences
    of Ukraine. (source: Y. Rassamakin)'
...
- slider_image: /assets/media/items/5Moncuk.png
  caption: Reconstruction of horse decoration with the pendant, using the rock crystal
    center of the altar cross. Reconstruction Y. Rassamakin, design V. B. Pankovsky.
...
- slider_image: /assets/media/items/kurgan.jpg
  caption: Burial site reconstruction.
- slider_image: /assets/media/items/Treasury.jpg
  caption: View of tresury.
start_year: 1201
end_year: 1300

...
item_image_caption: The light core of the Studenica church based on a point cloud
  and parametric model of the church
slider_images:
- slider_image: /assets/media/items/Core_Drawing_Yellow-01.png
  caption: The light core of the Studenica Church extracted from a point cloud and
    parametric model of the church
- slider_image: /assets/media/items/Screen_Shot_2020-10-06_at_7.39.59_PM.png
  caption: Geometric and proportional analysis of the Studenica church based on the
    principle of the circle and “holy triangle” and related to a point cloud of the
    church
- slider_image: /assets/media/items/MappingEE_Studenica_Xuo1wcQ.png
...
**Team**: Jelena Bogdanović, Charles Kerton, Leslie Forehand, Dušan Danilović, Travis Yaeger, Jacob Gasper, Debanjana Chatterjee, Magdalena Dragović, Aleksandar Čučaković, and Marko Pejić  

**Website**: <http://studenica.design.iastate.edu/>  

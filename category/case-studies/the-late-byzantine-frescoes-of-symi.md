...
item_image_caption: 'Figures from the scene of the Betrayal of Jesus, north wall (naos),
  St. Ioannis tis Tsagkrias, Symi (source: M. Asfentagakis).'
slider_images:
- slider_image: /assets/media/items/02_pxP3nv0m.jpg
  caption: 'The depiction of the Women at the Tomb, south wall (naos), St. Marina
    tis Neras, Symi (source: M. Asfentagakis).'
- slider_image: /assets/media/items/03_4DvQnLB7.jpg
  caption: 'The surviving scene from the iconographic cycle of St. Marina, holy bema,
    St. Marina tis Neras, Symi (source: M. Asfentagakis).'
- slider_image: /assets/media/items/04_uBBADopf.jpg
  caption: 'The depiction of the Descent into Limbo, south wall (naos), St. Prokopios,
    Symi (source: M. Asfentagakis).'
- slider_image: /assets/media/items/05_ikji6eKe.jpg
  caption: 'One of the scenes of the iconographic cycle of St. Prokopios, north wall
    (naos), St. Prokopios, Symi (source: M. Asfentagakis).'
- slider_image: /assets/media/items/06_SNnBHGMY.jpg
  caption: 'The figure of St. Lawrence, holy bema, Monastery of Archangel Michael
    Roukouniotis (old *katholikon*), Symi (source: M. Asfentagakis).'
start_year: 1308
end_year: 1523

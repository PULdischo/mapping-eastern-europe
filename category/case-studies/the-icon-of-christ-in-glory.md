...
item_image_caption: 'Christ in Glory icon, middle to the 2nd half of the 16th century,
  Galicia.Provenance: From the end of the 19th century until 1945, the icon was kept
  in the collection of the Church and Archaeological Museum in Chelm (Poland). (source:National
  Preserve "Kyiv–Pechersk Lavra"]'
slider_images: []
start_year: 1500
end_year: 1599
author: Alina Kondratiuk
type:
- Panel painting
locations: []
subjects:

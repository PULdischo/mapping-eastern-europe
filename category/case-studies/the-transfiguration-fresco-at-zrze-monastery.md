...
slider_images:
- slider_image: /assets/media/items/1A_copy.jpg
  caption: 'Zrze Monastery, view from the east (souce: I. M. Đorđević)'
- slider_image: /assets/media/items/1B1_copy.jpg
  caption: 'The Catholicon of the Zrze Monastery, view from the southwest (source:
    I. M. Đorđević)'
- slider_image: /assets/media/items/2.PNG
  caption: 'Transfiguration Fresco, west façade of the church, 1368/69 (source: A.
    Golac Čubrilo)'
- slider_image: /assets/media/items/31_copy.jpg
  caption: 'Zrze Monastery, eastern wall of the porch, western façade with the Tranfiguration
    fresco, 1368/69; 17th century (source: I. M. Đorđević)'
- slider_image: /assets/media/items/41_copy.jpg
  caption: 'The Donor''s Inscription above the Entrance to the Catholicon of the Zrze
    Monastery, with the scenes of Apostles’ Communion and Bust of Martyrs in medallions,
    western wall, 1368/1369 (source: I. M. Đorđević)'
start_year: 1360
end_year: 1369
author: Anđela Gavrilović
type:
- Wall painting
locations:
